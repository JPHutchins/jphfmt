...
[[maybe_unused]] static int demonstrate_wrapping(
    ...
    for (
        size_t current_sample_index = 0; current_sample_index < total_number_of_samples;
    ...
    if (averaged_result > MINIMUM_ACCEPTABLE_THRESHOLD
        && averaged_result < MAXIMUM_ACCEPTABLE_THRESHOLD && averaged_result != 0) {
